...
public class MainActivity extends AppCompatActivity {
    ...
    //CMakeLists.txt ->cpp파일에서 생성되는 공유 라이브러리와 OpenCV 공유 라이브러리를 빌드하는데 사용
    //빌드된 공유 라이브러리를 자바 코드에서 로드
    static {
    ...
    //자바 코드에 선언해둔 네이티브 함수를 통해 공유라이브러리에 있는 함수를 호출
    ...
    private void imageprocess_and_showResult(int th1, int th2) {
        ...
        //네이티브 함수에 두 개의 Mat 객체 주소와 두개의 threshold를 넘겨주면 cpp에 있는 함수에 전달됨
